...
const NewAppointment = () => {
  ...
  return (
    <div className="new-appointment-container">
      <NewAppointmentMenu />
      <h1 className="font-mono text-4xl font-black text-white pt-[15%] tracking-widest tracking-widest">BOOK APPOINTMENT</h1>
      ...
      <form onSubmit={handleSubmit} className="content-evenly flex flex-row w-[80vw] content-between space-x-1.5">
        ...
        <div className="pl-[5%]">
          ...
          <input
            type="time"
            id="time"
            className="rounded-3xl py-[7px] px-[15px] px-[15px] border-gray-300 outline-4"
            value={time}
