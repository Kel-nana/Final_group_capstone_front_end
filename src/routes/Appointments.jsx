  ...
  return (
    <div className="flex h-full p-4 sm:p-0">
      ...
      <div className="flex flex-col gap-8 mt-24 mx-auto w-[80%]">
        ...
        {appointmentsStatus === 'loading' && <div>Loading...</div>}

        {appointmentsStatus === 'succeeded' && Array.isArray(appointmentsData) && (
        ...
        {appointmentsStatus === 'succeeded'
          && Array.isArray(appointmentsData) && appointmentsData.map((appointment) => (
            <ul
              key={appointment.id}
