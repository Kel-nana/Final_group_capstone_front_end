    ...
    <div>
      ...
      <div className="flex justify-center align-center flex-col text-center mt-16 p-4 sm:flex-row sm:justify-between md:ml-96 md:-mt-125 lg:-mt-125">
        ...
        <div className="flex flex-col mt-4">
          ...
          <button
            type="button"
            className="flex flex-row items-center justify-evenly mt-8 rounded-full bg-green-400 py-4 px-8 cursor-pointer hover:bg-green-500 transition-bg w-64 mx-auto sm:w-full"
          >
      ...
      <div>
        ...
        <Link to="/doctors">
          <button
            type="button"
            className="back-btn flex flex-row items-center justify-evenly mt-8 ml-70 rounded-r-full  bg-green-400 py-4 px-8 cursor-pointer hover:bg-green-500 transition-bg"
          >
